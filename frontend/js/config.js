...
export const CORPUS = {
  // Domain currently implemented: Psychology and Psychiatry
  DOMAIN: 'psyn', // Update this to match your domain code
  
  // Vector file paths (dynamic for both local and GitHub Pages environments)
  // Update these to match your file paths and names
  VECTOR_PATHS: {
    document: `${basePath}/vectors/psyn/psyn-document-vectors.json`,
    section: `${basePath}/vectors/psyn/psyn-section-vectors.json`, 
    paragraph: `${basePath}/vectors/psyn/psyn-paragraph-vectors.json`
  },
  
  // Database paths (dynamic for both local and GitHub Pages environments)
  // Update these to match your file paths and names
  DATABASE_PATHS: {
    en: `${basePath}/corpora/psyn/eng/psyn-eng_database.json`,
    es: `${basePath}/corpora/psyn/esp/psyn-esp_database.json`
  }
};
